...
SESSIONS_FILE = Path(__file__).parent / "sessions" / "v4_sessions.json"
...
def load_all_sessions() -> list[dict]:
    return session_store.load_all_sessions(SESSIONS_FILE)


def write_all_sessions(sessions: list[dict]):
    session_store.write_all_sessions(sessions, SESSIONS_FILE)
